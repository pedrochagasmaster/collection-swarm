...
_BLEACH_ALLOWED_TAGS = [
    ...
    "blockquote", "strong", "em", "a", "br", "hr", "span", "dl", "dt", "dd",
]
_BLEACH_ALLOWED_ATTRS = {"a": ["href", "title"], "th": ["align"], "td": ["align"]}
...
def create_app(
    ...
    def get_playbook(format: str = Query("html", description="html or markdown")) -> dict[str, str]:
        ...
        html = bleach.clean(html, tags=_BLEACH_ALLOWED_TAGS, attributes=_BLEACH_ALLOWED_ATTRS)
