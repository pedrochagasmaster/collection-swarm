...
| **Requires** | Dashboard/CLI key for `nvidia_nim`, or `NVIDIA_NIM_API_KEY` fallback |
...
| **Requires** | Dashboard/CLI key for `cursor`, or `CURSOR_API_KEY` fallback; Node.js 22+; `cursor_sdk_bridge/` |
