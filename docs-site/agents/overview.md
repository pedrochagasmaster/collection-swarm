...
After evaluating a completed transcript, the Judge produces a structured [`Judgment`](../backends/overview.md) object:
...
- [Backend Overview](../backends/overview.md) — how LLM calls are dispatched
